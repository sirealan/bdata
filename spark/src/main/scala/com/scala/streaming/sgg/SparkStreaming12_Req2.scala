package com.scala.streaming.sgg

import java.text.SimpleDateFormat

import com.flink.bigdata.spark.streaming.SparkStreaming11_Req1_BlackList.AdClickData
import com.flink.bigdata.spark.util.JDBCUtil
